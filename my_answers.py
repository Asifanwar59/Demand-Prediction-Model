...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        #final_outputs = self.activation_function(final_inputs) # signals from final output layer, use this for classification output.
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #output_error_term = error * final_outputs * (1 - final_outputs, , use this for classification output.
